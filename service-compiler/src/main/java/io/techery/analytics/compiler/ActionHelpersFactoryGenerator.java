...
public class ActionHelpersFactoryGenerator extends CodeGenerator<AnalyticActionClass> {
   ...
   private CodeBlock formatJavadoc() {
      final String format = new StringBuilder()
            .append("Factory to provide generated helper-classes. <br/><br/>\n")
            .append("For {@link $T}'s internal use only, <br/>\n")
            .append("in case if client code needs to make use of <br/>\n")
            .append("helper (e.g. for wrapper service) - use {@link $T} <br/><br/>\n")
            .append("\n")
      ...
      final ClassName helperCacheClassName = ClassName.get("io.techery.analytics.service", "AnalyticActionHelperCache");

      return CodeBlock.builder().add(format, analyticsServiceClassName, helperCacheClassName).build();
   }
}
